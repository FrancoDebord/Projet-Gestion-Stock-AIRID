                                ...
                                @foreach($movements as $movement)
                                    <tr>
                                        ...
                                        <td class="border border-gray-300 px-4 py-2">
                                            <a href="{{ route('stock-items.show', $movement->stockItem) }}" class="text-blue-500 hover:underline">
                                        ...
                                        <td class="border border-gray-300 px-4 py-2">
                                            <a href="{{ route('movements.show', $movement) }}" class="text-blue-600 hover:underline mr-2">Voir</a>
                                            @if(auth()->user()->hasPermission('manage_settings'))
                                                <a href="{{ route('movements.edit', $movement) }}" class="text-indigo-600 hover:underline mr-2">Modifier</a>
                                                @if($movement->type !== 'adjustment')
                                                    <form action="{{ route('movements.destroy', $movement) }}" method="POST" class="inline" onsubmit="return confirm('Supprimer ce mouvement ?');">
                                                        @csrf
                                                        @method('DELETE')
