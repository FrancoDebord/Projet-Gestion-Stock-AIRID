                ...
                <form action="{{ route('stock-items.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="stock_location_id" required class="form-select @error('stock_location_id') is-invalid @enderror">
                                ...
                                @foreach($locations as $loc)
                                    <option value="{{ $loc->id }}" @if(old('stock_location_id') == $loc->id) selected @endif>{{ $loc->stock_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="productCategorySelect" name="product_category_id" class="form-select @error('product_category_id') is-invalid @enderror">
                                ...
                                @foreach($categories as $cat)
                                    <option value="{{ $cat->id }}" @if(old('product_category_id') == $cat->id) selected @endif>{{ $cat->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="initial_quantity" value="{{ old('initial_quantity', 0) }}" required min="0" class="form-control @error('initial_quantity') is-invalid @enderror">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="min_quantity" value="{{ old('min_quantity', 5) }}" required min="0" class="form-control @error('min_quantity') is-invalid @enderror">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="unit" value="{{ old('unit', 'piece') }}" required class="form-control @error('unit') is-invalid @enderror">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="unit_price" value="{{ old('unit_price') }}" step="0.01" min="0" class="form-control @error('unit_price') is-invalid @enderror">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="type_usage_product" required class="form-select @error('type_usage_product') is-invalid @enderror">
                                <option value="consumed" @if(old('type_usage_product') == 'consumed') selected @endif>Consommé</option>
                                <option value="finished" @if(old('type_usage_product') == 'finished') selected @endif>Produit Fini</option>
                            </select>
