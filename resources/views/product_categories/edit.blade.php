...
<div class="container py-4">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h1 class="h4 mb-3">Modifier la Catégorie</h1>
            ...
            <div class="card shadow-sm p-4">
                <form action="{{ route('product-categories.update', $productCategory) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" value="{{ old('name', $productCategory->name) }}" required class="form-control @error('name') is-invalid @enderror">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="stock_location_id" class="form-select @error('stock_location_id') is-invalid @enderror">
                            ...
                            @foreach($stockLocations as $location)
                                <option value="{{ $location->id }}" {{ old('stock_location_id', $productCategory->stock_location_id) == $location->id ? 'selected' : '' }}>
                                    {{ $location->stock_name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('product-categories.show', $productCategory) }}" class="btn btn-light">Annuler</a>
